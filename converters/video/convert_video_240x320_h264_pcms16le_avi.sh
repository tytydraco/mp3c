...
function convert_video_240x320_h264_pcms16le_avi() {
    [[ -z "${1:-}" ]] && return 1

    local input_file="$1"
    local output_file="${input_file%.*}.240x320_h264_pcms16le.avi"
...
export FFMPEG_MOD
export -f convert_video_240x320_h264_pcms16le_avi